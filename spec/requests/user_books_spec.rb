...
RSpec.describe "/user_books", type: :request do
  ...
  # UserBooksController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get user_books_url, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested user_book" do
        user_book = UserBook.create! valid_attributes
        patch user_book_url(user_book),
              params: { user_book: new_attributes }, headers: valid_headers, as: :json
        user_book.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the user_book" do
        user_book = UserBook.create! valid_attributes
        patch user_book_url(user_book),
              params: { user_book: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the user_book" do
        user_book = UserBook.create! valid_attributes
        patch user_book_url(user_book),
              params: { user_book: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested user_book" do
      user_book = UserBook.create! valid_attributes
      expect {
        delete user_book_url(user_book), headers: valid_headers, as: :json
      }.to change(UserBook, :count).by(-1)
    end
  end
end
